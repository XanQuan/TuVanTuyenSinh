...
<section class="heading-page header-text" id="top" style="background-image: url('public/assets/images/meetings-bg.jpg'); background-attachment: fixed;">
    <div class="container text-center">
        <h6 class="text-uppercase text-white" style="letter-spacing: 2px;">Đào tạo & Kỹ năng</h6>
        <h2 class="text-white" style="font-weight: 800; text-transform: uppercase;">Các Khóa Học Phổ Biến</h2>
    </div>
</section>
            ...
            <div class="col-lg-8">
                ...
                <?php if(isset($_GET['search']) && !empty($_GET['search'])): ?>
                    <div class="text-center mt-3">
                        <p class="text-muted">Kết quả cho: <strong>"<?= htmlspecialchars($_GET['search']) ?>"</strong> 
        ...
        <div class="row">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="course-card-pro" 
                        ...
                        <div class="thumb-container">
                            ...
                            <img src="public/assets/images/<?= htmlspecialchars(!empty($c['image']) ? $c['image'] : 'course-01.jpg') ?>" 
                        ...
                        <div class="content-body">
                            ...
                            <div class="meta-info d-flex justify-content-between">
                                <span class="instructor">
                                    <i class="fa fa-user-tie me-2"></i><?= htmlspecialchars($c['teacher'] ?? 'Chuyên gia') ?>
                                </span>
                                <span class="rating-pro">
                                    <i class="fa fa-star me-1"></i><?= number_format($c['rating'], 1) ?>
                                </span>
                            </div>
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    ...
                    <p class="text-muted fs-5">Hiện chưa có khóa học nào được cập nhật.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<style>
    ...
    .btn-search-pro:hover { background: #1f272b; color: #fff; }
    ...
    .category-tag { color: #be1e2d; font-size: 12px; font-weight: 800; text-transform: uppercase; margin-bottom: 10px; }
    .course-title { font-size: 22px; font-weight: 700; color: #2a2a2a; margin-bottom: 20px; height: 58px; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; }
    .rating-pro { color: #ffa800; background: #fff9e6; padding: 2px 10px; border-radius: 10px; font-weight: 700; }
    .course-desc { color: #777; font-size: 15px; height: 72px; overflow: hidden; margin-bottom: 25px; }
    
    .btn-register-pro { 
        display: flex; align-items: center; justify-content: center; 
        background: #1f272b; color: #fff !important; padding: 15px; 
